...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        {
            return Math.PI * this.Radius * this.Radius * (this.A - this.B).Magnitude;
        }

        public double GetArea()
        {
            return 2 * Math.PI * this.Radius * this.Radius + 2 * Math.PI * this.Radius * (this.A - this.B).Magnitude;
        }
                ...
                case "area":
                    {
                        ...
                        {
                            Console.WriteLine("{0:F2}", ((IAreaMeasurable)currentFigure).GetArea());
                        }
                        else
                        {
                ...
                case "normal":
                    {
                        ...
                        {
                            Vector3D normal = ((IFlat)currentFigure).GetNormal();
                ...
                case "volume":
                    {
                        ...
                        {
                            Console.WriteLine("{0:F2}", ((IVolumeMeasurable)currentFigure).GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
