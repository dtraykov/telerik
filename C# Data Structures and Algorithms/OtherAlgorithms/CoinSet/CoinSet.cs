   ...
   public class CoinSet
    {
       ...
       public static int? GreedyChange(int[] coins, int targetTotal)
        {
            if (coins.Length == 0)
            {
                if (targetTotal == 0)
            ...
            {
                var maybe = GreedyChange(remaining, targetTotal - currentTotal + (toDrop * maxCoin));
       ...
       public static int? RandomChange(int[] coins, int targetTotal, int totalIterations)
        {
